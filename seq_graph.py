...
#TODO: Provide flag for user to turn off this option if its taking too long.
#Default to just removing ALL sequences that had a conflict.
#TODO: Internal threshold: If BELOW, approximate maximal independent set,
#      If ABOVE, calculate ANY independent set!
...
def approximateIndependentSet(graph):
    return(nxaa.maximum_independent_set(graph))
...
G = multiGraphFromList(example_10)

M = approximateIndependentSet(G)
print("Maximum independent set approximated: ",M)

N = naiveIndependentSet(G)
